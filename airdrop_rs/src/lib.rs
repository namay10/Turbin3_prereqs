...
mod tests {
    ...
    use solana_program::{
        hash::hash, pubkey::Pubkey, system_instruction::transfer, system_program,
    };
    use solana_sdk;
    ...
    fn transfer_sol() {
        ...
        let to_pubkey = Pubkey::from_str("4YH9pgaC1a9Ff4m7Z1nCViExVLn9goV4ybqWEPaQxY27").unwrap();
    ...
    fn enroll() {
        ...
        let (authority, _bump) = Pubkey::find_program_address(auth_seeds, &turbin3_prereq_program);
